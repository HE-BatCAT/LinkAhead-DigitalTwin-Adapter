...
logger = logging.getLogger("edge_node_dt")

group = SparkplugGroup()
edge_node_builder = group.edge_nodes["edge_node_dt"]
edge_node = edge_node_builder.build()

# Connect to broker
edge_node.connect()

url_metric_builder = edge_node_builder.devices["dt"].metrics["url_cycling_xlsx"]
decision_metric_builder = edge_node_builder.devices["dt"].metrics["cycling_decision"]
